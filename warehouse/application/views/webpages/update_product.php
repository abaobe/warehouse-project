                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">تعديل صنف</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>نموذج تعديل</h4>
                                    <span class="tools">
                                            ...
                                            <div class="controls">
                                                <select id="category_id" name="category_id" class="span6 chosen" data-placeholder="إختيـار فئة..." tabindex="1">
                                                    ...
                                                    <?php foreach ($categories as $value) { ?>
                                                        <option <?php if (!(strcmp($product_info[0]['CATEGORY_ID'],$value['CATEGORY_ID']))) {echo "selected=\"selected\"";} ?> value="<?= $value['CATEGORY_ID'] ?>"><?= $value['CATEGORY_NAME'] ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
