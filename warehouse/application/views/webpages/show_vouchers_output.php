                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">مستند اخراج اللوازم</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>جدول يحتوي على الطلبات المصروفة</h4>
                                    <span class="tools">
...
//                });
            ...
            function print_(current){
                ...
                $.ajax({
                        url: '<?php echo base_url() . "reports/vouchers_output/"; ?>',
                        data: {
