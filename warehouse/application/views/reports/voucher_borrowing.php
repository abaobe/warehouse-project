         ...
         $ttt = '<div class = "wrapper">'
             ...
             . '<div class = "bordered_row" style="padding: 4px 0;">
                              ...
                              <div  style=" width:30%;float:left;border:1px solid ;border-radius:10px;padding:4px"> 
                                  ...
                                  <div style="border:1px solid ;border-radius:5px; margin-bottom: 2px;">الرقم الطلب ...'.$products[0]['ORDER_NUMBER'].'...:</div>
                                  <div style="border:1px solid ;border-radius:5px;">التاريخ الطلب ...'.$products[0]['ORDER_DATE'].'...:</div>
                                ...
                                <div style="width:68.5%;float:left;padding:8px 0px 0px 0px "> 
                                  ...
                                  <div><label style="display: inline;padding-right: 20px;">إلى/ '.$products[0]['EMPLOYEE_NAME'].'-'. $products[0]['DEPARTMENT_NAME'].'-'.$products[0]['MAIN_DEPARTMENT'].'  </label></div>
             ...
             . '<div class = "row"><table border="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style = "width:10%" rowspan="2">تاريخ الاعارة</th>
