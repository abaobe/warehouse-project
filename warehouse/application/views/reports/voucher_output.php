    ...
    <body>
        <?php
         ...
         $ttt = '<div class = "wrapper">'
             ...
             . '</div>'
             .'<div class="row">
              <div style = "float:left;width:33.3%;text-align: center">بموجب طلب لوازم ...'.$products[0]['ORDER_NUMBER'].'...:</div>
             ...
             <div class="row">
              <div style = "float:left;width:30%;text-align: center">بتاريخ ...'.$products[0]['ORDER_DATE'].'...:</div>
              <div style = "float:left;width:69.5%;text-align: right">إلى / ...'.$products[0]['EMPLOYEE_NAME'].'-'.$products[0]['DEPARTMENT_NAME'].'-'.$products[0]['MAIN_DEPARTMENT'].'...</div>
             ...
             . '<div class = "row"><table border="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style = "width:10%"><p align = "center">تاريخ الصرف</p></th>
                             ...
                             foreach ($products as $value) {
                                               ...
                                               if ($value['UNIT_TYPE']=='primary') {
                                                   $unit_name=$value['PRIMARY_UNIT_NAME'];
                                               }else{
                                                   $unit_name=$value['SECONDARY_UNIT_NAME'];
                                               }
                                                    $ttt.='<td>'.$unit_name.'</td>
                                                    <td>'.$value['QUANTITY_DISBURSED'].'</td>
