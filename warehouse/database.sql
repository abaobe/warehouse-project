--------------------------------------------------------
--  File created - Wednesday-May-07-2014   
--------------------------------------------------------
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ORCL"."BORROWING_VOUCHER_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 25 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ORCL"."INSERT_NUMBER_SEQ"  MINVALUE 1 MAXVALUE 99999999999999999 INCREMENT BY 1 START WITH 52 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence ORDERED_SUPPLIES_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ORCL"."ORDERED_SUPPLIES_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 401 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence ORDER_NUMBER_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ORCL"."ORDER_NUMBER_SEQ"  MINVALUE 1 MAXVALUE 99999999999999999 INCREMENT BY 1 START WITH 49 NOCACHE  NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence PRODUCTS_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ORCL"."PRODUCTS_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 161 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "ORCL"."VOUCHER_INSERT_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 361 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VOUCHER_OUTPUT_SEQ
--------------------------------------------------------

   CREATE SEQUENCE  "ORCL"."VOUCHER_OUTPUT_SEQ"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 201 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into ORCL.CATEGORIES (CATEGORY_ID,CATEGORY_NAME,CATEGORY_DESCRIPTION,PARENT_ID) values (1,'أجهزة كهربائية','كل ما يتعلق بالأجهزة الكهربائية',0);
Insert into ORCL.CATEGORIES (CATEGORY_ID,CATEGORY_NAME,CATEGORY_DESCRIPTION,PARENT_ID) values (2,'أجهزة الحاسوب','كل ما يتعلق بأجهزة الحاسوب وملحقاتة',0);
Insert into ORCL.CATEGORIES (CATEGORY_ID,CATEGORY_NAME,CATEGORY_DESCRIPTION,PARENT_ID) values (3,'أثاث','كل ما يتعلق بالاثاث',0);
...
Insert into ORCL.CATEGORIES (CATEGORY_ID,CATEGORY_NAME,CATEGORY_DESCRIPTION,PARENT_ID) values (61,'اجهزة الكترونية','اجهزة الكترونية اجهزة الكترونية',0);
Insert into ORCL.CATEGORIES (CATEGORY_ID,CATEGORY_NAME,CATEGORY_DESCRIPTION,PARENT_ID) values (62,'اجهزة الكترونية "ا"',null,61);
Insert into ORCL.CATEGORIES (CATEGORY_ID,CATEGORY_NAME,CATEGORY_DESCRIPTION,PARENT_ID) values (63,'اللللل',null,61);
...
Insert into ORCL.DEPARTMENTS (DEPARTMENT_ID,DEPARTMENT_NAME,ADDRESS,PHONE,NOTES,ADDED_DATE,PARENT_ID,MOBILE,FAX) values (21,'محكمة رفح','نننن','45465','نشسمتيشس',to_date('30-MAR-14','DD-MON-RR'),0,null,null);
...
SET DEFINE OFF;
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (184,4000,300,1,to_date('25-FEB-14','DD-MON-RR'),'شيب',123,'primary','2014/28','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (181,1,100,1,to_date('24-FEB-14','DD-MON-RR'),'نميشس',123,'secondary','2014/26','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (182,1,200,1,to_date('24-FEB-14','DD-MON-RR'),'يتسنبيسب',123,'primary','2014/27','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (183,4000,100,1,to_date('24-FEB-14','DD-MON-RR'),'يبيس',123,'primary','2014/27','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (187,1,2,2,to_date('25-FEB-14','DD-MON-RR'),'نك',123,'primary','2014/30','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (165,41,45,2,to_date('22-FEB-14','DD-MON-RR'),'تاسنتشاينس',123,'secondary','2014/23','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (166,341,777,2,to_date('22-FEB-14','DD-MON-RR'),'ةمشسنيك',123,'secondary','2014/23','waiting',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (167,41,78,2,to_date('22-FEB-14','DD-MON-RR'),'تمن',123,'primary','2014/24','waiting',null,null,null,null);
...
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (101,341,1000,1,to_date('16-FEB-14','DD-MON-RR'),'طلبية مستعجلة',123,'primary','2014/5','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (103,341,12,1,to_date('17-FEB-14','DD-MON-RR'),'اتيسبانيسب',123,'secondary','2014/7','refuse',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (81,344,15,1,to_date('16-FEB-14','DD-MON-RR'),'مستعجل!!',123,'secondary','2014/4','refuse',null,null,null,null);
...
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (123,1,10,1,to_date('17-FEB-14','DD-MON-RR'),'ثثثث',123,'primary','2014/9','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (124,4000,5,1,to_date('17-FEB-14','DD-MON-RR'),'مممم',123,'primary','2014/9','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (125,4000,6,1,to_date('17-FEB-14','DD-MON-RR'),'ششش',123,'primary','2014/10','waiting',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (121,4000,10,1,to_date('17-FEB-14','DD-MON-RR'),'ششش',123,'primary','2014/8','waiting',null,null,null,null);
...
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (162,348,10,2,to_date('21-FEB-14','DD-MON-RR'),'تنمشسي',123,'secondary','2014/20','refuse',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (163,348,2,2,to_date('21-FEB-14','DD-MON-RR'),'انيتشمسني',123,'secondary','2014/21','waiting',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (164,348,10,2,to_date('21-FEB-14','DD-MON-RR'),'تمشسي',123,'primary','2014/22','refuse',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (168,341,12,2,to_date('22-FEB-14','DD-MON-RR'),'تينمشستي',123,'primary','2014/25','waiting',null,null,null,null);
...
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (186,1,10,1,to_date('25-FEB-14','DD-MON-RR'),'تا',123,'primary','2014/29','accept',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (285,81,2,2,to_date('07-APR-14','DD-MON-RR'),'ىشسنميتشسي',123,'primary','2014/39','waiting','دائرة المبيعات','حازم الغلاييني','123456','101');
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (321,350,10,null,to_date('09-APR-14','DD-MON-RR'),'تنمتم',123,'primary','2014/41','waiting',null,null,null,null);
...
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (324,4000,2,2,to_date('09-APR-14','DD-MON-RR'),'تاتنانت',123,'primary','2014/42','waiting',null,'حازم','121213','101');
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (362,348,12,1,to_date('21-APR-14','DD-MON-RR'),'note1',123,'primary','2014/46','waiting',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (363,344,455,1,to_date('21-APR-14','DD-MON-RR'),'notes2',123,'secondary','2014/46','waiting',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (343,4000,100,1,to_date('18-APR-14','DD-MON-RR'),'asjkdjlkas',123,'primary','2014/44','accept','hardware','hazim','123456789','p123');
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (361,null,null,1,to_date('21-APR-14','DD-MON-RR'),null,123,null,'2014/45','waiting',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (364,4000,12,50,to_date('21-APR-14','DD-MON-RR'),'kjaslkd',123,'primary','2014/47','waiting','msadh','hazim','123456798','101');
...
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (381,4000,1,3,to_date('05-MAY-14','DD-MON-RR'),'jsjdklasd',123,'primary','2014/48','waiting','jhjk','hazim','12132132','101');
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (281,81,1212,2,to_date('03-APR-14','DD-MON-RR'),'ملاحظة',123,'secondary','2014/37','waiting',null,null,null,null);
Insert into ORCL.ORDERED_SUPPLIES (ORDER_ID,PRODUCT_ID,QUANTITY,DEPARTMENT_ID,ADDED_DATE,NOTES,APPLICANT_ID,UNIT_TYPE,ORDER_NUMBER,STATUS,SECTION_NAME,EMPLOYEE_NAME,EMPLOYEE_NUMBER,ROOM_NUMBER) values (282,81,1212,2,to_date('03-APR-14','DD-MON-RR'),'ملاحظة',123,'secondary','2014/37','waiting','2014/37','2014/37','2014/37','2014/37');
...
Insert into ORCL.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRODUCT_NUMBER,PRODUCT_TYPE,NOTES,CATEGORY_ID,WIDTH,HEIGHT,H_LENGTH,RE_DEMAND_BORDER,PRIMARY_UNIT_NAME,SECONDARY_UNIT_NAME,PRIMARY_UNIT_QUANTITY,SECONDARY_UNIT_QUANTITY,QUANTITY_STATUS) values (41,'اقلام','#1087','1','يشستياشس',41,'50','50','50',100,'عدد','باكو',300,141,'invisible');
Insert into ORCL.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRODUCT_NUMBER,PRODUCT_TYPE,NOTES,CATEGORY_ID,WIDTH,HEIGHT,H_LENGTH,RE_DEMAND_BORDER,PRIMARY_UNIT_NAME,SECONDARY_UNIT_NAME,PRIMARY_UNIT_QUANTITY,SECONDARY_UNIT_QUANTITY,QUANTITY_STATUS) values (4000,'جهاز حاسوب','4568','2','dasd',1,'645','5','45',45,'رطل','كيلو',11,530,'invisible');
Insert into ORCL.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRODUCT_NUMBER,PRODUCT_TYPE,NOTES,CATEGORY_ID,WIDTH,HEIGHT,H_LENGTH,RE_DEMAND_BORDER,PRIMARY_UNIT_NAME,SECONDARY_UNIT_NAME,PRIMARY_UNIT_QUANTITY,SECONDARY_UNIT_QUANTITY,QUANTITY_STATUS) values (1,'سماعة حاسوب','747','1','dasd',41,'645','5','45',45,'asdasd','ggg',5039,518,'visible');
Insert into ORCL.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRODUCT_NUMBER,PRODUCT_TYPE,NOTES,CATEGORY_ID,WIDTH,HEIGHT,H_LENGTH,RE_DEMAND_BORDER,PRIMARY_UNIT_NAME,SECONDARY_UNIT_NAME,PRIMARY_UNIT_QUANTITY,SECONDARY_UNIT_QUANTITY,QUANTITY_STATUS) values (350,'دباسة','#51','1','سشينمتشس',42,'50','50','50',600,'عدد','كرتونة',91979,200,'visible');
Insert into ORCL.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRODUCT_NUMBER,PRODUCT_TYPE,NOTES,CATEGORY_ID,WIDTH,HEIGHT,H_LENGTH,RE_DEMAND_BORDER,PRIMARY_UNIT_NAME,SECONDARY_UNIT_NAME,PRIMARY_UNIT_QUANTITY,SECONDARY_UNIT_QUANTITY,QUANTITY_STATUS) values (344,'لاصق','#502','1','سشينمتشس',43,'50','50','60',600,'عدد','كرتونة',102697,200,'visible');
Insert into ORCL.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRODUCT_NUMBER,PRODUCT_TYPE,NOTES,CATEGORY_ID,WIDTH,HEIGHT,H_LENGTH,RE_DEMAND_BORDER,PRIMARY_UNIT_NAME,SECONDARY_UNIT_NAME,PRIMARY_UNIT_QUANTITY,SECONDARY_UNIT_QUANTITY,QUANTITY_STATUS) values (348,'اقلام جاف','#50','1','سشينمتشس',44,'50','50','50',600,'عدد','كرتونة',506,4442,'visible');
Insert into ORCL.PRODUCTS (PRODUCT_ID,PRODUCT_NAME,PRODUCT_NUMBER,PRODUCT_TYPE,NOTES,CATEGORY_ID,WIDTH,HEIGHT,H_LENGTH,RE_DEMAND_BORDER,PRIMARY_UNIT_NAME,SECONDARY_UNIT_NAME,PRIMARY_UNIT_QUANTITY,SECONDARY_UNIT_QUANTITY,QUANTITY_STATUS) values (341,'ورق أبيض','#508','1','سشينمتشس',null,'50','50','50',600,'عدد','كرتونة',1390,500,'visible');
...
Insert into ORCL.VOUCHER_INSERT (VOUCHER_ID,PRODUCT_ID,RECEIVED_FROM,BILLING_ID,ADDED_DATE,NOTES,RECEIVER_ID,QUANTITY,UNIT_PRICE,CURRENCY_TYPE,UNIT_TYPE,RECEIVED_DATE,INSERT_NUMBER) values (281,121,22,'101',to_date('09-APR-14','DD-MON-RR'),'اتنانتانتا',123,10,5,'شيكل','10',null,null);
...
Insert into ORCL.VOUCHER_INSERT (VOUCHER_ID,PRODUCT_ID,RECEIVED_FROM,BILLING_ID,ADDED_DATE,NOTES,RECEIVER_ID,QUANTITY,UNIT_PRICE,CURRENCY_TYPE,UNIT_TYPE,RECEIVED_DATE,INSERT_NUMBER) values (261,81,1,'4546',to_date('08-APR-14','DD-MON-RR'),'سشتينمتشسيم',123,1212,121,'دولار','secondary',null,null);
...
Insert into ORCL.VOUCHER_INSERT (VOUCHER_ID,PRODUCT_ID,RECEIVED_FROM,BILLING_ID,ADDED_DATE,NOTES,RECEIVER_ID,QUANTITY,UNIT_PRICE,CURRENCY_TYPE,UNIT_TYPE,RECEIVED_DATE,INSERT_NUMBER) values (219,81,1,'123',to_date('28-MAR-14','DD-MON-RR'),'jkasjd',123,100,212,'شيكل','primary',null,null);
Insert into ORCL.VOUCHER_INSERT (VOUCHER_ID,PRODUCT_ID,RECEIVED_FROM,BILLING_ID,ADDED_DATE,NOTES,RECEIVER_ID,QUANTITY,UNIT_PRICE,CURRENCY_TYPE,UNIT_TYPE,RECEIVED_DATE,INSERT_NUMBER) values (221,81,1,'101',to_date('29-MAR-14','DD-MON-RR'),'hjHSks',123,1021,222,'دينار','1021',null,null);
Insert into ORCL.VOUCHER_INSERT (VOUCHER_ID,PRODUCT_ID,RECEIVED_FROM,BILLING_ID,ADDED_DATE,NOTES,RECEIVER_ID,QUANTITY,UNIT_PRICE,CURRENCY_TYPE,UNIT_TYPE,RECEIVED_DATE,INSERT_NUMBER) values (241,348,1,'123',to_date('08-APR-14','DD-MON-RR'),'jkldjaklsjdas',123,100,10,'أغورة','100',null,null);
...
Insert into ORCL.VOUCHER_OUTPUT (VOUCHER_ID,UNIT_TYPE,QUANTITY_DISBURSED,ORDER_SUPPLIES_ID,ADDED_DATE,NOTES) values (181,null,null,null,to_date('05-MAY-14','DD-MON-RR'),null);
--------------------------------------------------------
...
-------------------------------------------------------------
  ...
  FUNCTION get_inserted_static_prod(
    ...
    ELSIF columnData = 'part' THEN
      ...
      get_company_nameBy_id(i.received_from) AS company_name FROM INSERTED_STATIC_PRODUCT i WHERE product_id = prod_id;
    END IF;
...
----------------------------------------------------------- 
 ...
 FUNCTION next_insert_number
  ...
  BEGIN
    ...
    o_num := curr_year||'/'||next_seq_val;
    SELECT count(*) INTO found FROM VOUCHER_INSERT WHERE INSERT_NUMBER = o_num;
    IF found > 0 THEN
