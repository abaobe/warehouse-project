...
<!--[if !IE]><!--> <html lang="en"> <!--<![endif]-->
    ...
    <head>
        <meta charset="utf-8" />
        <title>إضافة إدارة أو دائرة</title>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="#">إضافة إدارة أو دائـرة جديدة</a><span class="divider-last">&nbsp;</span></li>
                            </ul>
                        ...
                        <div class="span12">
                            ...
                            <div class="widget">
                                <div class="widget-title">
                                    <h4><i class="icon-reorder"></i>يمكنك إضافة إدارة أو دائرة</h4>
                                    <span class="tools">
