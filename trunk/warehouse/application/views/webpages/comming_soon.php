...
<head>
  ...
  <meta content="" name="author" />
        ...
        <link href="<?php echo base_url(); ?>resource/assets/coming-soon-knob/Template/css/style.css" rel="stylesheet">
...
<body id="coming-body" >
      ...
      <div class="container-fluid">
          <div class="row-fluid">
              <div class="span12 responsive" data-tablet="span4" data-desktop="span12">
                  <h1>
                      <label>الموقع تحت الصيانة</label>
                      <span></span>
                  </h1>
                  <br><br>
  ...
  <!--coming soon js-->
  <script src="<?php echo base_url(); ?>resource/assets/coming-soon-knob/Template/js/style.js"></script>
