         ...
         $ttt = '<div class = "wrapper">'
             ...
             . '<div class = "bordered_row" style="padding: 4px 0;">
                              ...
                              <div  style=" width:30%;float:left;border:1px solid ;border-radius:10px;padding:4px"> 
                                  ...
                                  <div style="border:1px solid ;border-radius:5px; margin-bottom: 2px;">الرقم</div>
                                ...
                                <div style="width:68.5%;float:left;padding:8px 0px 0px 0px "> 
                                  ...
                                  <div style="border-bottom:1px solid;padding: 0; margin-bottom: 2px;"><label style="display: inline; padding-right: 20px;padding-top: 30px">من ...'.$main_department.'-'.$department_name.'... :</label></div>
             ...
             . '<div class = "row"><table border="1">
                                        ...
                                        <tbody>
                                                <tr class="odd gradeX">
                                                    ...
                                                    <td>'.$product_info[0]['H_LENGTH'].'</td>
                                                    <td>'.$product_info[0]['WIDTH'].'</td>
                                                    
                                                    <td>'.$product_info[0]['HEIGHT'].'</td>
                                                    <td>'.$product_status.'</td>
                                                    <td> '.$product_info[0]['PRIMARY_UNIT_NAME'].'</td>
                                                    <td> '.$product_info[0]['SERIAL_NUMBER'].'</td>
                                                    <td> </td>
