    ...
    <body>
        <?php
         ...
         $ttt = '<div class = "wrapper">'
             ...
             . '<hr/></div>'
             . ' <h4 align = "center">مستنـــد إعـــارة</h4>'
             . '<div class = "bordered_row" style="padding: 4px 0;">
                              
                              <div  style=" width:30%;float:left;border:1px solid ;border-radius:10px;padding:4px"> 
                                 
                                  <div style="border:1px solid ;border-radius:5px; margin-bottom: 2px;">الرقم ...'.$products[0][4].'... :</div>
                                  <div style="border:1px solid ;border-radius:5px;">التاريخ '.date('y/m/d').' :</div>
                                ...
                                <div style="width:68.5%;float:left;padding:8px 0px 0px 0px "> 
                                  ...
                                  <div style="border-bottom:1px solid;padding: 0; margin-bottom: 2px;"><label style="display: inline; padding-right: 20px;padding-top: 30px">من / دائرة المخازن والمستودعات</label></div>
                                  <div><label style="display: inline;padding-right: 20px;">إلى/ '.$products[0][7][0]['EMPLOYEE_NAME'].'-'. $products[0][7][0]['DEPARTMENT_NAME'].'  </label></div>
             ...
             . '<div class = "row"><table border="1">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style = "width:10%" rowspan="2">تاريخ الإرجاع</th>
                                        ...
                                        foreach ($products as $item) {
                                            ...
                                            $ttt.='<tr>
                                                <td>'.$i.'</td>
                                                <td>'.  $item[7][0]['PRODUCT_NAME'] .'</td>
                                                <td>'.$item[7][0]['H_LENGTH'] .'</td>
                                                <td>'.$item[7][0]['WIDTH'].'</td>
                                                <td>'.$item[7][0]['HEIGHT'].'</td>
                                                <td>'.$item[5].'</td>';
//                                            $unit_name;
//                                            if ($item[5]=='primary') {
...
//                                            }
                                               $ttt.=' <td>'.  $item[7][0]['PRIMARY_UNIT_NAME'] .'</td>
                                                <td>'.$item[2].'</td>
                                                <td> '.$item[6].'</td>
                                                <td>'.$item[1].'</td>
                                            </tr>';
